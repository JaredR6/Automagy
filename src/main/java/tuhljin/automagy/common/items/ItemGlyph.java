...
public class ItemGlyph extends ModVariantItem {
    ...
    private static String[] sprites = new String[]{"automagy:items/glyph-overlay/void", "automagy:items/glyph-overlay/consume", "automagy:items/glyph-overlay/siphon", "automagy:items/glyph-overlay/envy", "automagy:items/glyph-overlay/temperance", "automagy:items/glyph-overlay/preserve", "automagy:items/glyph-overlay/guzzler", "automagy:items/glyph-overlay/reservoir", "automagy:items/glyph-overlay/bovine"};

    public ItemGlyph() {
        super(ImmutableMap.<Integer, String>builder().put(0, "ink").put(1, "v").put(2, "c").put(3, "s").put(4, "e").put(5, "t").put(6, "p").put(7, "g").put(8, "r").put(9, "b").build());
    }
