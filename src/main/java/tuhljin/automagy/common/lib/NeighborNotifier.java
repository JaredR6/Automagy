...
public class NeighborNotifier {
    ...
    public static void notifyBlocksOfExtendedNeighborChange(World world, BlockPos pos) {
        notifyBlocksOfExtendedNeighborChange(world, pos.getX(), pos.getY(), pos.getZ());
    }

    public static void notifyBlocksOfExtendedNeighborChange(World world, int x, int y, int z) {
        if (!world.isRemote) {
    ...
    private static void notifyBlockUpdate(World world, int x, int y, int z) {
